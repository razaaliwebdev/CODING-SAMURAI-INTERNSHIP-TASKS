...
const Hero = () => {
  ...
  return (
    <section id="home" className="h-[70vh] w-full flex  justify-center">
      <div className=" py-16 flex items-center flex-col">
        ...
        <p className="text-muted md:max-w-2xl text-sm mx-auto text-center md:text-lg">
        ...
        <div className="btns flex gap-4 my-8">
          <button
            ...
            className="px-6 py-2 text-secondary border border-primary rounded-full bg-primary hover:bg-secondary hover:text-primary text-text cursor-pointer"
          >
            View My Work
          </button>
          <button
            onClick={() => navigate("/#contact")}
            className="px-6 py-2 text-secondary border border-primary rounded-full bg-secondary hover:bg-primary hover:text-seondary text-text cursor-pointer "
          >
            Let's Talk
          </button>
        </div>
